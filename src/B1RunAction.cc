...
B1RunAction::B1RunAction(G4double x0, G4double ZValue, G4double AbsHoleDiam, G4double TBR, G4int SourceSelect, G4int SensorChoice, G4String OutFileName)
	: G4UserRunAction(),
	  ...
	  fEdep2("Edep2", 0.),
	  fEdkin("Edkin", 0.), fX0Scan(x0), fZValue(ZValue), fAbsHoleDiam(AbsHoleDiam), fTBR(TBR), fSourceSelect(SourceSelect), fSensorChoice(SensorChoice), fOutFileName(OutFileName)
