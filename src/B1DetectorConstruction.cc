...
//		posDummyExitAbs = G4ThreeVector(0, 0, posAbs.z() +fAbsorberThickness/2.+ DzDummyExitAbs/2.);
	...
	if (fSourceSelect!=5 && fSourceSelect!=7 && fSourceSelect!=10) new G4PVPlacement(0,posDummyExitSorg,logicShapeDummyExitSorg,"DummyExitSorg",logicWorld,false,0,checkOverlaps);        //overlaps checking
