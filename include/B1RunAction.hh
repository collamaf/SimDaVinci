...
public:
	...
	std::vector<G4double>& GetRunPreAbsEn() {return RunVectorPreAbsEn; }
	std::vector<G4double>& GetRunPartPreAbs() {return RunVectorPartPreAbs; }
...
//	G4Accumulable<G4double> fEdepSiPM;
	...
	std::vector<G4double> RunVectorPreAbsEn;
